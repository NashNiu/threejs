...
dracoLoader.setDecoderPath("/42/draco/");
 ...
 * Environment map
 */
rgbeLoader.load("/42/urban_alley_01_1k.hdr", (environmentMap) => {
...
const uniforms = {
  ...
  uTimerFrequency: new THREE.Uniform(0.4),
  uStrength: new THREE.Uniform(0.3),

  uWrapPositionFrequency: new THREE.Uniform(0.38),
  uWrapTimerFrequency: new THREE.Uniform(0.12),
  uWrapStrength: new THREE.Uniform(1.7),
  uColorA: new THREE.Uniform(new THREE.Color(debugObject.colorA)),
  uColorB: new THREE.Uniform(new THREE.Color(debugObject.colorB)),
};
// Material
const material = new CustomerShaderMaterial({
  //csm
...
const depthMaterial = new CustomerShaderMaterial({
  //csm
  ...
  uniforms,
  // mesh depth material
  depthPacking: THREE.PackingDepth,
});
...
gui.add(uniforms.uTimerFrequency, "value", 0, 2, 0.001).name("Timer Frequency");
gui.add(uniforms.uStrength, "value", 0, 2, 0.001).name("Strength");

gui
  .add(uniforms.uWrapPositionFrequency, "value", 0, 2, 0.001)
  .name("Wrap Position Frequency");
gui
  .add(uniforms.uWrapTimerFrequency, "value", 0, 2, 0.001)
  .name("Wrap Timer Frequency");
gui.add(uniforms.uWrapStrength, "value", 0, 2, 0.001).name("Wrap Strength");
...
// model
gltfLoader.load("/42/suzanne.glb", (gltf) => {
