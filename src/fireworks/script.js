...
const textures = [
    textureLoader.load('/firework/particles/1.png'),
    textureLoader.load('/firework/particles/2.png'),
    textureLoader.load('/firework/particles/3.png'),
    textureLoader.load('/firework/particles/4.png'),
    textureLoader.load('/firework/particles/5.png'),
    textureLoader.load('/firework/particles/6.png'),
    textureLoader.load('/firework/particles/7.png'),
    textureLoader.load('/firework/particles/8.png')
]
...
folderClouds.add(effectController, 'cloudCoverage', 0, 1, 0.01).name('coverage').onChange(updateSky);
folderClouds.add(effectController, 'cloudDensity', 0, 1, 0.01).name('density').onChange(updateSky);
folderClouds.add(effectController, 'cloudElevation', 0, 1, 0.01).name('elevation').onChange(updateSky);
