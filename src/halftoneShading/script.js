...
gui.add(material.uniforms.uShadowRepetitions, 'value').min(1).max(200).step(1)
gui
...
gui.add(material.uniforms.uLightRepetitions, 'value').min(1).max(200).step(1).name('lightRepetitions')
gui
